...
import { 
  ...
  Trophy, Settings, Phone // Added Phone icon import here
} from 'lucide-react';
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
          <div className="space-y-1.5">
            ...
            <input 
              ...
              className="!w-full !px-3 !py-2.5 !bg-gray-50 hover:!bg-white !border !border-gray-200 focus:!bg-white focus:!outline-none focus:!ring-2 focus:!ring-green-100 focus:!border-[#1abc60] !text-sm !text-gray-900 !rounded-lg !transition-all"
            />
          </div>
          <div className="space-y-1.5">
            ...
            >
              <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50 shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg font-bold text-gray-900 leading-tight">New Offline Booking</h2>
                    <p className="text-xs text-gray-500 font-medium mt-0.5">Record a walk-in reservation</p>
                  </div>
                </div>
                <button 
              ...
              <form onSubmit={handleCreateOffline} className="flex flex-col flex-1 overflow-hidden">
                <div className="p-6 space-y-6 overflow-y-auto custom-scrollbar flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      <label className="block text-sm font-semibold text-gray-700">Select Venue <span className="text-red-500">*</span></label>
                      <select 
                        required
                        value={offlineData.turfId} 
                        onChange={(e) => setOfflineData({...offlineData, turfId: e.target.value, slots: [], courts: []})}
                        className="!w-full !px-3 !py-2.5 !bg-gray-50 hover:!bg-white !border !border-gray-200 focus:!bg-white focus:!outline-none focus:!ring-2 focus:!ring-[#1abc60]/20 focus:!border-[#1abc60] !text-sm !text-gray-900 !rounded-lg !transition-all !appearance-none cursor-pointer"
                      >
                    ...
                    <div className="space-y-1.5">
                      <label className="block text-sm font-semibold text-gray-700">Select Sport</label>
                      <input 
                        type="text"
                        placeholder="e.g. Football"
                        value={offlineData.sport}
                        onChange={(e) => setOfflineData({...offlineData, sport: e.target.value})}
                        className="!w-full !px-3 !py-2.5 !bg-gray-50 hover:!bg-white !border !border-gray-200 focus:!bg-white focus:!outline-none focus:!ring-2 focus:!ring-[#1abc60]/20 focus:!border-[#1abc60] !text-sm !text-gray-900 !rounded-lg !transition-all placeholder:!text-gray-400"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      <label className="block text-sm font-semibold text-gray-700">Calculated Total</label>
                      <div className="w-full bg-gray-50 border border-gray-200 px-3 py-2.5 rounded-lg font-bold text-gray-900 text-sm">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="!w-full !pl-9 !pr-3 !py-2.5 !bg-gray-50 hover:!bg-white !border !border-gray-200 focus:!bg-white focus:!outline-none focus:!ring-2 focus:!ring-[#1abc60]/20 focus:!border-[#1abc60] !text-sm !text-gray-900 !rounded-lg !transition-all placeholder:!text-gray-400"
                        />
                      </div>
                    </div>
                    <div className="space-y-1.5">
                  ...
                  {offlineData.turfId && (
                    <div className="space-y-6 pt-4 border-t border-gray-100">
                      ...
                      <div className="space-y-2">
                        <label className="block text-sm font-semibold text-gray-700">Select Courts <span className="text-red-500">*</span></label>
                          ...
                          {getTurfCourts(offlineData.turfId).map((court: any) => {
                            ...
                            return (
                              <button
                                ...
                                className={`px-4 py-2 rounded-lg font-semibold text-xs uppercase tracking-wide transition-all border ${
                      ...
                      {/* Slot Selection */}
                      <div className="space-y-2">
                        <label className="block text-sm font-semibold text-gray-700">Select Time Slots <span className="text-red-500">*</span></label>
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 max-h-48 overflow-y-auto p-2 bg-gray-50 rounded-xl border border-gray-200 custom-scrollbar">
                          {buildSlotsForTurf(offlineData.turfId, offlineData.date).map((slot: any) => {
                            ...
                            return (
                              <button
                                ...
                                className={`px-3 py-2 rounded-lg border font-semibold text-xs transition-all ${
