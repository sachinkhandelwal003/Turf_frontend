...
// Eye aur CheckCircle import kar liye hain
...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const data = await apiRequest('/auth/login', 'POST', { email, password } as any );
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-2">
              ...
              <Link href="/ForgotPassword" className="text-[11px] font-bold text-[#1abc60] hover:underline">Forgot password?</Link>
            </div>
